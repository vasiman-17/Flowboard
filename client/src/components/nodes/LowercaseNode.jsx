  ...
  return (
    <div className={`flow-node transform-node ${result?.status === 'error' ? 'node-error' : ''}`}>
      ...
      <div className="node-header">
        ...
        <span className="node-title">Lowercase</span>
      </div>

      <div className="node-body">
        <span style={{ fontSize: '11px', color: 'var(--text-tertiary)' }}>Converts text to lowercase</span>
      </div>
...
export default memo(LowercaseNode);
