  ...
  return (
    <div className={`flow-node transform-node ${result?.status === 'error' ? 'node-error' : ''}`}>
      ...
      <div className="node-header">
        ...
        <span className="node-title">Parse JSON</span>
      </div>

      <div className="node-body">
        <span style={{ fontSize: '11px', color: 'var(--text-tertiary)' }}>Parses JSON string → Object</span>
      </div>
...
export default memo(ParseJsonNode);
